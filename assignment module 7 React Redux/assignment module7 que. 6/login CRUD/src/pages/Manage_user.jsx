                            ...
                            <div className="row mt">
                                <div className="col-md-12">
                                    <div className="content-panel">
                                        <h1>Manage User <span className='btn btn-danger btn-xs text-end' onClick={()=>redirect('/adduser')}><i className="fa fa-plus"/></span></h1><hr /><table className="table table-striped table-advance table-hover">
                                            <thead>
                                                <tr>
                                                    <th>Id</th>
                                                    <th>Name</th>
